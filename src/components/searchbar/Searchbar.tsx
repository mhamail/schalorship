  ...
  return (
    <div className="relative mt-1 ">
            <div className='h-auto'>
                <input type="text"
                    className="lg:w-80 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-highlight focus:border-highlight block w-56 pl-12 p-2.5 outline-none"
                    placeholder="Search"
                />
            </div>
